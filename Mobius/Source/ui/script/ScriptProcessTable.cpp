...
void ScriptProcessTable::updateContent()
{
    table.updateContent();
}
 ...
 */
void ScriptProcessTable::initTable()
{
    // from the example
 ...
 */
void ScriptProcessTable::initColumns()
{
...
int ScriptProcessTable::getPreferredWidth()
{
    // todo: adapt to column configuration
    return 500;
}

int ScriptProcessTable::getPreferredHeight()
{
    int height = 400;
 ...
 */
void ScriptProcessTable::resized()
{
 ...
 * ButtonBar::Listener
 */
void ScriptProcessTable::buttonClicked(juce::String name)
{
    (void)name;
}
 ...
 */
int ScriptProcessTable::getNumRows()
{
 ...
 */
void ScriptProcessTable::paintRowBackground(juce::Graphics& g, int rowNumber,
 ...
 * 14 is 63% of 22
 */
void ScriptProcessTable::paintCell(juce::Graphics& g, int rowNumber, int columnId,
                             int width, int height, bool rowIsSelected)
{
    (void)columnId;
    //ScriptProcessTableRow* row = symbols[rowNumber];
 ...
 */
void ScriptProcessTable::cellDoubleClicked(int rowNumber, int columnId, const juce::MouseEvent& event)
{
    (void)rowNumber;
    (void)columnId;
    (void)event;
 ...
 */
void ScriptProcessTable::selectedRowsChanged(int lastRowSelected)
{
