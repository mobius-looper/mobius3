...
class SyncAnalyzer
{
  public:
    ...
    /**
     * Lock the unit length at it's current value.
     * Once locked, beat pulses will be generated by a virtual loop "playing"
     * the unit.  Drift correction begins after locking.
     * If the source tempo deviates significantly, then the unit length may change
     * and track followers will no longer receive drift corrections.
     */
    virtual void lock() = 0;
