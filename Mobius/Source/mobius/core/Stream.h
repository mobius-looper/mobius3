// old core code related to handling the audio stream under Track
...
class InputStream : public Stream {
  ...
  public:
	...
	void setInputBuffer(class MobiusAudioStream* stream, float* input, long frames, 
						float* echo);
...
class OutputStream : public Stream {
  ...
  public:
	...
	void setOutputBuffer(class MobiusAudioStream* stream, float* b, long l);
