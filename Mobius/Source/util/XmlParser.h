...
class XmlEventAdapter : public XmlEventHandler {
  ...
  public:
	...
	virtual void closeDoctype(class XmlMiniParser *p);
	...
	virtual void closeStartTag(class XmlMiniParser *p, int empty);
	virtual void endTag(class XmlMiniParser *p, char *name);
	virtual void comment(class XmlMiniParser *p, char *text);
	virtual void pi(class XmlMiniParser *p, char *text);
	virtual void pcdata(class XmlMiniParser *p, char *text);
	virtual void entref(class XmlMiniParser *p, char *name);
	virtual void cdata(class XmlMiniParser *p, char *text);

	// still needs thought
	virtual void error(class XmlMiniParser *p, int code,
								 const char *msg);
...
class XmlMiniParser {
  ...
  public:
    ...
    void halt(void);		// stop parsing and reset
	void skip(void);		// skip over the current "object"
